...
1. 指定工作负载不调度到 `NVIDIA-NVIDIA L4` 类型的设备，请看[示例](../sources/nouse-gpu-type.yaml):
...
1. 指定设备 ID 调度，请看[示例](../sources/use-gpu-uuid.yaml):
...
1. 指定设备 ID 不调度，请看[示例](../sources/nouse-gpu-uuid.yaml):
